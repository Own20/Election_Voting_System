...
## Brief Description
This portfolio repository showcase the creator's ability in creating a complex relational database management system based on real-world problems. A voting database system handles a wide range of tables with complex ballot system, including preferences distribution for election purposes.

## Overview
This project implements a database backend for a computerised Australian federal election voting system designed for the House of Representatives elections. The objective of this project is to design and implement a high-performance, scalable, and integrity-preserving database architecture capable of supporting millions of registered voters while maintaining strict requirements for data confidentiality, integrity, and transparency in elections.
